...
#   :::::::::::::::::  ATTENDENCE ::::::::::::::::::::#
    ...
    path('pms_attandance_sap_report/', views.PmsAttandanceSAPExportView.as_view()),

    #:::::::::::::::::::: L I V E   T R A C K I N G :::::::::::::::::#
    path('pms_live_tracking_for_all_employees/<project_id>/', views.PmsLiveTrackingForAllEmployeesView.as_view()),
    path('pms_live_tracking_for_a_employee_in_project/<employee_id>/', views.PmsLiveTrackingForAEmployeeInAProjectView.as_view()),
    ...
    path('v2/pms_flexi_team_fortnight_attendance/',views.PmsFlexiTeamFortnightAttendance.as_view()),
    ...
    path('v2/pms_attendance_grace_leave_list_first_modified/', views.PmsAttendanceGraceLeaveListModifiedV2View.as_view()),


    path('v2/pms_attendance_leave_approval_list/',views.PmsAttendanceLeaveApprovalListV2View.as_view()), # team
    
    # Generate SAP Report
    path('v2/pms_attendance_admin_sap_report/',views.PmsAttandanceAdminSAPReportView.as_view()),

    # Generate OS/MIS Report
    path('v2/pms_attendance_admin_od_mis_report/',views.PmsAttandanceAdminOdMsiReportView.as_view()),

    # Advance Leave Apply
    path('v2/pms_attendance_advance_leave_add/',views.PmsAttendanceAdvanceLeaveAddV2View.as_view()),
    
    # Attendance Fortnight Cron API
    path('pms/attendance/cron/', views.PmsAttendanceCronView.as_view()),

    # Leave Balance insert for transfer a user from PMS to HRMS upto transfer date
    
    path('pms/attendance/add/leave_balance_for_transfer_user/', views.PmsAttendanceLeaveBalanceTransferUserView.as_view()),
