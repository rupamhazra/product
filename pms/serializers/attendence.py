...
class PmsAttendanceAdvanceLeaveAddV2Serializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if empDetails_from_coreuserdetail:
            ...
            last_attendence_date = PmsAttandanceDeviation.objects.all().values_list(
...
class PmsAttandanceAdminOdMsiReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = PmsAttandanceDeviation
        fields = '__all__'

class PmsAttendanceLeaveApprovalListV2Serializer(serializers.ModelSerializer):
    ...
    def get_employee_name(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            first_name=PmsAttandanceDeviation.attandance.employee.first_name if PmsAttandanceDeviation.attandance.employee.first_name  else ''
            last_name=PmsAttandanceDeviation.attandance.employee.last_name if PmsAttandanceDeviation.attandance.employee.last_name else ''
            name=first_name+" "+last_name
            return name
    def get_employee_id(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            return PmsAttandanceDeviation.attandance.employee.id

    def get_department(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            return PmsAttandanceDeviation.attandance.employee.cu_user.department.cd_name if PmsAttandanceDeviation.attandance.employee.cu_user.department else None
    
    def get_designation(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            return PmsAttandanceDeviation.attandance.employee.cu_user.designation.cod_name if PmsAttandanceDeviation.attandance.employee.cu_user.designation else None

    def get_reporting_head(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            return PmsAttandanceDeviation.attandance.employee.cu_user.reporting_head.first_name+' '+PmsAttandanceDeviation.attandance.employee.cu_user.reporting_head.last_name if PmsAttandanceDeviation.attandance.employee.cu_user.reporting_head else None

    def get_hod(self,PmsAttandanceDeviation):
        if PmsAttandanceDeviation.attandance:
            name = PmsAttandanceDeviation.attandance.employee.cu_user.hod.first_name+' '+PmsAttandanceDeviation.attandance.employee.cu_user.hod.last_name if PmsAttandanceDeviation.attandance.employee.cu_user.hod else None
            return name
    ...
    def create(self,validated_data):
        ...
        for data in validated_data.get('attendence_approvals'):
            ...
            if approved_status=='approved':
                ...
                approved_status_res = PmsAttandanceDeviation.objects.filter(approved_status = '2', id= data['req_id'])
                approved_data = PmsAttandanceDeviation.objects.filter(id=data['req_id']).update(approved_status=2,
                                                                        approved_by=updated_by,remarks=remarks)
                req_type = PmsAttandanceDeviation.objects.get(id=data['req_id']).deviation_type
                print("approved_data",approved_data,req_type)
                present_data = PmsAttendance.objects.filter(id__in=PmsAttandanceDeviation.objects.filter(
                ...
                approved_status_name = data['approved_status']
                approved_status_res = PmsAttandanceDeviation.objects.filter(approved_status = 3, id= data['req_id'])
                print("approved_status")
                
               
                if PmsAttandanceDeviation.objects.filter(deviation_type='FD',id=data['req_id']) :
                    
                    # print("full day ")
                    PmsAttandanceDeviation.objects.filter(deviation_type='FD',id=data['req_id']).\
                ...
                elif PmsAttandanceDeviation.objects.filter(deviation_type='OD',id=data['req_id']) :
                    # print("halfday day ")
                    duration_length=PmsAttandanceDeviation.objects.get(id=data['req_id'],is_requested=True)
                    prev_cal = PmsAttandanceDeviation.objects.filter(attandance=duration_length.attandance,is_requested=True,approved_status=3)
                    ...
                    if prev_cal:
                        ...
                        if duration_length.duration + reject_duration_sum_value >= 240:
                            attendance_request = PmsAttandanceDeviation.objects.filter(deviation_type='OD',id=data['req_id'])
                            ...
                            for x in ids:
                                PmsAttandanceDeviation.objects.filter(id=x).update(
                ...
                elif PmsAttandanceDeviation.objects.filter(deviation_type='HD',id=data['req_id']) :
                    # print("halfday day ")
                    duration_length=PmsAttandanceDeviation.objects.get(id=data['req_id'],is_requested=True)
                    prev_cal = PmsAttandanceDeviation.objects.filter(
                    ...
                    if prev_cal:
                        ...
                        # print("ids",ids)
                        if duration_length.duration + reject_duration_sum_value >= 240:
                            PmsAttandanceDeviation.objects.filter(deviation_type='HD',id=data['req_id']).update(
                ...
                od_detail = PmsAttandanceDeviation.objects.filter(deviation_type='OD',id=data['req_id'])
                ...
                approved_status_name = data['approved_status']
                approved_status_res = PmsAttandanceDeviation.objects.filter(approved_status = '5', id = data['req_id'])
                req_type = PmsAttandanceDeviation.objects.get(id=data['req_id'])
                before_data = req_type.approved_status
                PmsAttandanceDeviation.objects.filter(id=data['req_id']).update(
                    approved_status=5,
                    justification=None,
                    approved_by=updated_by,
                    remarks=remarks,
    ...
    def update(self,instance, validated_data):
        ...
        try:
            ...
            with transaction.atomic():
                ...
                present=PmsAttandanceDeviation.objects.filter(id=instance.id,attandance__is_present=True)
                ...
                if present:
                    ...
                    if request_type == 'HD' or request_type == 'FD':
                        ...
                        if leave_type in ('CL','SL','EL'):
                            ...
                            result = all_leave_calculation_upto_applied_date_pms(date_object=date_object, user=tcore_user)
                            ...
                            if  leave_type == 'SL' :
                                if balance_sl>0.0:
                                    duration_length=PmsAttandanceDeviation.objects.get(id=instance.id,is_requested=False)
                                    if request_type == 'HD':
                                        if duration_length.duration <=240 :
                                            # raise serializers.ValidationError("Please apply half day Your diviation exceeds 2.5 Hours")
                                    
                                            justify_attendence=PmsAttandanceDeviation.objects.filter(id=instance.id,is_requested=False).\
                                                    update(
                    ...
                    #*****************As the user is already present hence partial OD********************************************************
                        ...
                        is_auto_od = PmsAttandanceDeviation.objects.only('is_auto_od').get(id=instance.id,is_requested=False).is_auto_od
...
class AttendanceLogOutV2Serializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        last_login_id = PmsAttandanceLog.objects.filter(attandance = instance, login_logout_check='Login', login_id__isnull=True).values_list('id',flat=True).last()
        logout_log_details, created = PmsAttandanceLog.objects.get_or_create(
                    attandance = instance,
        ...
        # sf = PmsAttendance.objects.filter(employee_id= 4).values()        
    ...
    def add_deviations(self, att_id, log_out_time, owned_by,logout_log_details,last_login_id):
        ...
        owned_by = owned_by
        att_id = att_id
        #last_login  = PmsAttandanceLog.objects.filter(login_logout_check='Login').values_list('id',flat=True).last()
...
class AttendanceUpdateLogOutTimeFailedOnLogoutV2Serializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        time = validated_data.get("logout_time")
        updated_by = validated_data.get("updated_by")
        last_login_id = PmsAttandanceLog.objects.filter(login_logout_check='Login').values_list('id',flat=True).last()
        logout_log_details, created = PmsAttandanceLog.objects.get_or_create(
                    attandance = instance,
                    login_logout_check = 'Logout',
                    time=time,
...
class AttandanceALLDetailsListByPermissonV2Serializer(serializers.ModelSerializer):
    ...
    def get_login_logout_details(self, PmsAttendance):

        login_logout_list = list()
        queryset_att_log = PmsAttandanceLog.objects.filter(attandance=PmsAttendance.id,login_logout_check__in=('Logout',))
        ...
        if queryset_att_log:
            for e_queryset_att_log in queryset_att_log:
                ...
                login_logout_dict['login_time'] = PmsAttandanceLog.objects.filter(
                    attandance=PmsAttendance.id,id=e_queryset_att_log.login_id).values_list('time',flat=True).first()
                login_logout_dict['logout_time'] = e_queryset_att_log.time
                login_logout_list.append(login_logout_dict)
        
                attendance_deviation = PmsAttandanceDeviation.objects.filter(
                    attandance_id=PmsAttendance.id,
...
class PmsFlexiTeamFortnightAttendanceSerializer(serializers.ModelSerializer):
    class Meta:
        model = PmsAttendance
        fields = '__all__'
...
class AttandanceListWithOnlyDeviationByPermissonSerializer(serializers.ModelSerializer):
    ...
    def get_deviation_details(self, PmsAttendance):
        # print("PmsAttendance: ",PmsAttendance)
        attendance_deviation = PmsAttandanceDeviation.objects.filter(approved_status=4,attandance_id=PmsAttendance.id)
        serializer = AttandanceDeviationSerializer(instance=attendance_deviation, many=True)
        # print("serializer.data: ",serializer.data)
        return serializer.data
...
class AttandanceDeviationSerializer(serializers.ModelSerializer):
    ...
    def get_approved_status_name(self, PmsAttandanceDeviation):
        return PmsAttandanceDeviation.get_approved_status_display()
    ...
    def create(self,validated_data):
        try:
            ...
            for data in validated_data.get('deviation_id'):
                all_closed_task = PmsAttandanceDeviation.objects.filter(id=data['id']).update(approved_status=approved_status,
                                                                                            remarks=remarks,
        ...
        try:
            ...
            if approved_status==4:
                for data in validated_data.get('leave_id'):
                    all_closed_task = PmsEmployeeLeaves.objects.filter(id=data['id']).update(approved_status=approved_status,
...
class PmsLiveTrackingForAllEmployeesSerializer(serializers.ModelSerializer):

    class Meta:
        model = PmsProjectUserMapping
