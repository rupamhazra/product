        ...
        for data in response.data:
            if data['mmr_user']:
                ...
                for employee in employee_details:
                    ...
                    project_details = TdmsProjectUserMapping.objects.filter(user_id=employee.cu_user_id)
                    projects = []
...
class ManPowerListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if project:
            ...
            user_list=TdmsProjectUserMapping.objects.filter(project__in=project)
            # print(user_list)
        ...
        for data in response.data['results']:
            if data['mmr_user']:
                ...
                for employee in employee_details:
                    ...
                    manpower_dict['contact_no'] = employee.cu_phone_no
                    data['mmr_user'] = manpower_dict
                    project_details = TdmsProjectUserMapping.objects.filter(
...
class ManPowerListDownloadView(generics.ListAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        file_name = ''
        if data_list:
            if os.path.isdir('media/tdms/manpower/document'):
                file_name = 'media/tdms/manpower/document/manpower_report.xlsx'
                file_path = settings.MEDIA_ROOT_EXPORT + file_name
            else:
                os.makedirs('media/tdms/manpower/document')
                file_name = 'media/tdms/manpower/document/manpower_report.xlsx'
                file_path = settings.MEDIA_ROOT_EXPORT + file_name
