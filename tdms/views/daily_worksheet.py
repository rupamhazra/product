...
class DailyWorkSheetAddView(generics.ListCreateAPIView):
    ...
    queryset = TdmsDailyWorkSheet.objects.filter(is_deleted=False).order_by('-id')
...
class DailyWorkSheetListView(generics.ListAPIView):
    ...
    queryset = TdmsDailyWorkSheet.objects.filter(Q(is_deleted=False))
...
class DailyWorkSheetTaskListDownloadView(generics.ListAPIView):
    ...
    def create_file_path(self):
        if os.path.isdir('media/tdms'):
            file_name = 'media/tdms/daily_work_sheet.xlsx'
        else:
            os.makedirs('media/tdms')
            file_name = 'media/tdms/daily_work_sheet.xlsx'
        return file_name